...
# time_1 = time.time()
# print('\nSpaCy_model time: ', time_1 - time_start)



# file_path = 'Chen et al 2006 Episodes.pdffigures2.figure'
# file_path = 'Koz Lenz and Melchin 2009.pdffigures2.figure'
# file_path = 'Maletz 2011 Isograptids.pdffigures2.figure'
# file_path = 'Jackson&Lenz2003.pdffigures2.figure'
# file_path = 'Goldman et al 2002.pdffigures2.figure'
# file_path = 'Koren and Melchin2000.pdffigures2.figure'
# file_path = 'Bates et al 2005.pdffigures2.figure'
file_path = 'Bates&Urbanek 2002.pdffigures2.figure'
...
# time_2 = time.time()
# print("Subgraph_model time: ", time_2 - time_1)

# yolo_word = roc_inf.mAP_Yolo()

# time_3 = time.time()
# print("Token_model time: ", time_3 - time_2)

image_ids = list(info.keys())
n = []
t = os.listdir('../input/' + file_path)
for image_id in image_ids:
    if image_id + '.png' in t:
        n.append(image_id)
image_ids = n
...
if not os.path.exists("../output/detection-results/" + file_path):
...
#     image_path = "../output_word/crop_results" + '/' + file_path + '/' + ocr_dir
#     ocr_res = hub.main(server_url, image_path)
#     # print(ocr_res)
#     ocr_dict[ocr_dir] = {}
#     for res in ocr_res.keys():
#         ind = res.rindex('/')
#         png = res[ind+1:]
#         key = ocr_res[res]['results'][0][0]['text']
#         ocr_dict[ocr_dir][key] = png
    # ocr_dict[ocr_dir] = ocr_res
# print(ocr_dict)
